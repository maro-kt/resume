...
Spacely という VR コンテンツを簡単に編集できる SaaS アプリケーションのインフラ側の構築、運用、および自動化。Web アプリケーションのIT基盤における改善。クラウド基盤のセキュリティ設計および改善。

#### 環境

* パブリッククラウド： AWS、GCP
* インフラ基盤/ツール： EC2、RDS Aurora, ECS, BigQuery, Terraform
* プロジェクト管理： Jira
* 開発言語： Ruby on Rails
