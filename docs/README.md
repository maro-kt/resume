...
1. AWS、GCP におけるセキュリティ基盤の整備。認証周り、インシデント管理、監査ログなどのセキュリティ運用で必要な基盤を整備
1. 社内データ分析基盤の強化。AWS Athena から BigQuery へのマイグレーション、および Salesforce とのデータ連携。Tableau を用いたデータ分析ツールの整備などを主導
